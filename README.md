...
```bash
# 从源码安装
go install github.com/openclaw-coding/skill-seed/cmd/skill-seed@latest
...
生成的 Claude Code Skills 会输出到项目内的 `.claude/skills/skill-seed-skills/`。
...
生成的 Skills 会被输出到项目内的 `.claude/skills/skill-seed-skills/`，Claude Code 会自动发现。
...
output:
  skills_path: .claude/skills/skill-seed-skills  # Skills 输出路径（相对于项目根目录）
...
| `output.skills_path` | string | .claude/skills/skill-seed-skills | generate-skills 命令的 `--output` 默认值（相对于项目根目录） |
...
```
.claude/skills/skill-seed-skills/      # 项目内的 Claude Code Skills
├── SKILL.md                           # 主入口
└── references/                        # 分类知识
...
- `.claude/skills/skill-seed-skills/` 是生成的 Skills 目录，位于项目内
...
```
.claude/skills/skill-seed-skills/       # 项目内的 Skills 目录
├── SKILL.md                            # 主入口
└── references/                         # 分类知识
    ├── naming-patterns/                # 命名模式
    │   ├── overview.md
